 ...
 * @since 01.04.2017
 */
public class DC_SQLColumn 
{
	private String strName;
	private JComponent jVisualComponent;
	private DC_SQLForeignKey oForeignKey=null;
	...
	/**
	 * 
	 * @param oKey {@link DC_SQLForeignKey}
	 * @author Jean
	 * @since 01.04.2017
	 */
	protected void setForeignKey(DC_SQLForeignKey oKey)
	{
		oForeignKey=oKey;
	}
	/**
	 * 
	 * @return {@link DC_SQLForeignKey} - das Fremdschlüsselobjekt
	 * @author Jean
	 * @since 01.04.2017
	 */
	public DC_SQLForeignKey getForeignKey()
	{
		return oForeignKey;
	}
	/**
	...
	public JComponent getInputComponent() throws SQLException
	{
		if(isForeignKey())
		{
			DC_SQLTable oForeignTable = new DC_SQLTable(oForeignKey.getReferencedTableName());
		...
		else
		{
			...
			{
				((JTextField) jVisualComponent).setText(DC_SQLConnector.simpleDateFormat.format(new Date()));
